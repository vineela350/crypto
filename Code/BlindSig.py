...
class Signer:
    ...
    def generateInformation(self):
        ...
        p = cryptomath.generate_prime()
        q = cryptomath.generate_prime()
        phi = (p - 1)*(q - 1)
        n = p*q
...
class Voter:
    ...
    def unwrapSignature(self, signedBlindMessage, n):
        ...
        rInv = cryptomath.calculate_mod_inverse(self.r, n) # ERR3
        print("rInv: ", rInv)
